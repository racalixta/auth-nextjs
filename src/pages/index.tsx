  ...
  return (
    <section className="flex items-center justify-center h-[100vh]">
      ...
      <div className="flex flex-col items-center">
        <h2 className="m-4 font-extrabold text-3xl">Faça seu login</h2>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <input 
              type="text" 
              name="email"
              className="p-2 bg-slate-800 outline-0 rounded-md "           
            />
          </div>
          ...
          <button 
            type="submit"
            className="bg-green-800 p-2 rounded-md text-zinc-50 font-medium"
          >
            Fazer Login
          </button>

          <fieldset className="border-t border-zinc-50 mt-2">
            <legend className="mx-auto px-4 text-zinc-50 text-1xl italic">ou</legend>
            <div className="text-zinc-50 pt-2">Acesse com o seu:</div>
          </fieldset>
